...
class Map:
    ...
    def setMap(self):
        layers = {
                'boundary': import_csv_layout('/home/justyn/FOP/FOPAssignment/map_Barriers.csv')
                }
        ...
        self.knight = Knight((700,1500),[self.visibleSprites],self.obstacleSprites)

    def run(self):
        self.visibleSprites.customDraw(self.knight)
...
class Camera(pygame.sprite.Group):
    def __init__(self):
        ...
        self.floorSurface = pygame.image.load('/home/justyn/FOP/FOPAssignment/graphics/floor.png').convert()
